    ...
    SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/v1/ach-batches")
                        .hasAuthority("SCOPE_ach-batches:create")
                        .requestMatchers(HttpMethod.GET, "/v1/ach-batches/*")
                        .hasAuthority("SCOPE_ach-batches:read")
                        .requestMatchers(HttpMethod.POST, "/v1/rtgs-payments")
